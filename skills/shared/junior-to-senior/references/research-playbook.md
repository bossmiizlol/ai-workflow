...
Goal: know what is _true here_ before judging the plan against it. Prefer a context-isolated explore subagent for broad sweeps; bring back conclusions, not file dumps.
...
Goal: find where the world moved after the training cutoff. Research the plan's _load-bearing decisions_ (from Phase 1a), not every line — typically 3-7 searches total, not 30.
