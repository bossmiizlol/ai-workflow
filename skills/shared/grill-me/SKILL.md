...
When the user asks to check a plan against project vocabulary, existing decisions,
or domain documentation, read [references/domain-review.md](references/domain-review.md).
Use the same calibration and question loop below; the reference adds source checks.
